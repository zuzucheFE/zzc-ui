...
var _infoConfig = require('../warnInfo/info.config.js');

var _infoConfig2 = _interopRequireDefault(_infoConfig);
...
var Time = function (_Component) {
    ...
    _createClass(Time, [{
        ...
        value: function verifyDate(pickupDay, returnDay) {
            ...
            if (!pickupDay) {
                this.showTextToast(_infoConfig2.default.toast1);
                return false;
            }

            if (!returnDay) {
                this.showTextToast(_infoConfig2.default.toast2);
                return false;
            }
            ...
            if (pickupInfo.year == returnInfo.year && pickupInfo.month == returnInfo.month && pickupInfo.day == returnInfo.day) {
                ...
                if (pTime == rTime || rTime < pTime) {
                    this.showTextToast(_infoConfig2.default.toast3);
                    return false;
                } else {
                    return true;
                }
        ...
        value: function confirm() {
            ...
            if (this.verifyDate(this.state.pickupDay, this.state.returnDay)) {
                var pickupInfo = this.state.pickupDay ? (0, _format2.default)(this.state.pickupDay, this.state.isOpenTimePicker) : null,
                    returnInfo = this.state.returnDay ? (0, _format2.default)(this.state.returnDay, this.state.isOpenTimePicker) : null,
                    _props = this.props,
        ...
        value: function setWarnInfo(type) {
            ...
            if (hasTodayPickupAndReturn && pickupTime >= returnTime) {
                ...
                warnID = 1;
                this.showWarn(_infoConfig2.default.warn1);
                return false;
            }
            ...
            if (!hasTodayPickupAndReturn && pickupDay.time.getTime() < returnDay.time.getTime() && returnTime > pickupTime) {
                ...
                warnID = 2;
                this.showWarn(_infoConfig2.default.warn2);
                return false;
            }
        ...
        value: function render() {
            ...
            var _props2 = this.props,
                hideController = _props2.hideController,
                isOpenTimePicker = _props2.isOpenTimePicker,
                startTime = _props2.startTime,
                endTime = _props2.endTime,
                timeRange = _props2.timeRange,
                dayList = _props2.dayList,
                JSXElem = _props2.JSXElem,
                pickupPlaceholder = _props2.pickupPlaceholder,
                returnPlaceholder = _props2.returnPlaceholder;
