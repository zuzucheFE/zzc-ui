...
var Picker = function (_Component) {
    ...
    function Picker(props) {
        ...
        var isOpenTimePicker = props.isOpenTimePicker == undefined ? true : isOpenTimePicker,
            hideController = props.hideController == undefined ? false : props.hideController,
            initStartTime = (0, _arrayToDate.startArrayToDate)(startTime),
            ...
            dayList = (0, _setDayList2.default)(initStartTime, initEndTime, pickupDay, returnDay, props.yesterdayClick),
            ...
            dayCount = pickupDay && returnDay ? _this.setDayCount(pickupDay, returnDay) : null;
    ...
    _createClass(Picker, [{
            ...
            if (nextProps.startTime && nextProps.endTime) {
                ...
                if (newStart != oldStart || newEnd != oldEnd) {
                    var initStartTime = (0, _arrayToDate.startArrayToDate)(nextProps.startTime),
                        ...
                        dayList = (0, _setDayList2.default)(initStartTime, initEndTime, null, null, nextProps.yesterdayClick);
        ...
        key: 'setDayCount',
        value: function setDayCount() {
            var resetDayCount = this.props.resetDayCount;

            if (resetDayCount) {
                return resetDayCount.apply(undefined, arguments);
            } else {
                return _dateTool.setDayCount.apply(undefined, arguments);
            }
        }
        ...
        value: function resetAllData(nextProps) {
            var newPickupTime = nextProps.pickupTime ? (0, _format2.default)(nextProps.pickupTime) : null,
                ...
                dayList = (0, _setDayList2.default)(this.state.startTime, this.state.endTime, pickupDay, returnDay, nextProps.yesterdayClick);
        ...
        key: 'startComponent',
        value: function startComponent(isShow, yesterdayTimeRange) {
            if (isShow) {
        ...
        key: 'show',
        value: function show(yesterdayTimeRange) {
            var _props = this.props,
                _confirmEvent = _props.confirmEvent,
                _closeEvent = _props.closeEvent,
                _props$onChangeDate = _props.onChangeDate,
                _onChangeDate = _props$onChangeDate === undefined ? function () {} : _props$onChangeDate,
                defaultTime = _props.defaultTime,
                timeRange = _props.timeRange,
                _props$lang = _props.lang,
                lang = _props$lang === undefined ? 'cn' : _props$lang,
                yesterdayClick = _props.yesterdayClick,
                resetDayCount = _props.resetDayCount;
            ...
            _index2.default.show(_react2.default.createElement(_index4.default, {
                ...
                onChangeDate: function onChangeDate(opt) {
                    _onChangeDate(opt);
                },
