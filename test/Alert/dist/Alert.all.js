...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_Component) {
	    ...
	    _createClass(App, [{
	        key: "open",
	        value: function open() {
	            var alert = (0, _index.Alert)('', '确认删除吗?', [{ text: '取消', onPress: function onPress() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    { onClick: function onClick() {
	                            (0, _index.Alert)('', '确认删除吗?', [{ text: '取消', onPress: function onPress() {
	                                    return console.log('cancel');
	                                } }, { text: '删除', onPress: function onPress() {
	                                    return console.log('ok');
	                                }, style: { 'color': '#108ee9', 'fontWeight': 'bold' } }]);
	                ...
	                _react2.default.createElement(
	                    "button",
	                    { onClick: function onClick() {
	                            (0, _index.Alert)('删除', '确认删除吗?', [{ text: '取消', onPress: function onPress() {
	                                    return console.log('cancel');
	                                } }, { text: '删除', onPress: function onPress() {
	                                    return console.log('ok');
	                                }, style: { 'color': '#108ee9', 'fontWeight': 'bold' } }]);
...
/***/ }
/******/ ]);
//# sourceMappingURL=Alert.all.js.map